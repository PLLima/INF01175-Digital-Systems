...
#
# Script generated by Vivado on Sun Jul 28 14:27:45 -03 2024
...
# script info
echo -e "BRAM.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/pllima0909/Documents/Git/INF01175-Digital-Systems/P07_-_Memory_FSM/P07_-_Memory_FSM.cache/compile_simlib/modelsim"
  fi
