...
#
# Script generated by Vivado on Sun Aug 25 18:16:24 -03 2024
...
#
# Usage        : mem_r.sh
#                mem_r.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem_r.sh [-reset_run]
#                mem_r.sh [-reset_log]
#                mem_r.sh [-help]
#
...
# script info
echo -e "mem_r.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem_r.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem_r xil_defaultlib.mem_r xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mem_r -key {Behavioral:sim_1:Functional:mem_r} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem_r.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mem_r.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mem_r.sh [-help]\n\
Usage: mem_r.sh [-step]\n\
Usage: mem_r.sh [-lib_map_path]\n\
Usage: mem_r.sh [-reset_run]\n\
Usage: mem_r.sh [-reset_log]\n\
Usage: mem_r.sh [-keep_index]\n\
Usage: mem_r.sh [-noclean_files]\n\n\
