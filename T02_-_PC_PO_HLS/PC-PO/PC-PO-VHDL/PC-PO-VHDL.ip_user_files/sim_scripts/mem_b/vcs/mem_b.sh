...
#
# Script generated by Vivado on Mon Aug 26 00:23:06 -03 2024
...
#
# Usage        : mem_b.sh
#                mem_b.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem_b.sh [-reset_run]
#                mem_b.sh [-reset_log]
#                mem_b.sh [-help]
#
...
#                script (type 'mem_b.sh -help' for more information).
#
...
# script info
echo -e "mem_b.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem_b.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mem_b xil_defaultlib.glbl -o mem_b_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mem_b_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mem_b_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mem_b_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mem_b.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mem_b.sh [-help]\n\
Usage: mem_b.sh [-step]\n\
Usage: mem_b.sh [-lib_map_path]\n\
Usage: mem_b.sh [-reset_run]\n\
Usage: mem_b.sh [-reset_log]\n\
Usage: mem_b.sh [-keep_index]\n\
Usage: mem_b.sh [-noclean_files]\n\n\
