...
#
# Script generated by Vivado on Sun Aug 25 23:38:58 -03 2024
...
#
# Usage        : mem_a.sh
#                mem_a.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem_a.sh [-reset_run]
#                mem_a.sh [-reset_log]
#                mem_a.sh [-help]
#
...
#                script (type 'mem_a.sh -help' for more information).
#
...
# script info
echo -e "mem_a.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem_a.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mem_a xil_defaultlib.glbl -o mem_a_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mem_a_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/pllima0909/Documents/Git/INF01175-Digital-Systems/T02_-_PC_PO_HLS/PC-PO/PC-PO-VHDL/PC-PO-VHDL.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key mem_a_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mem_a_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mem_a.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mem_a.sh [-help]\n\
Usage: mem_a.sh [-step]\n\
Usage: mem_a.sh [-lib_map_path]\n\
Usage: mem_a.sh [-reset_run]\n\
Usage: mem_a.sh [-reset_log]\n\
Usage: mem_a.sh [-keep_index]\n\
Usage: mem_a.sh [-noclean_files]\n\n\
