; ModuleID = '/home/pllima0909/Documents/Git/INF01175-Digital-Systems/T02_-_PC_PO_HLS/HLS/HLS/Basic_Solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_calculate_matrix_ir([2 x i8]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2" %a, [2 x i8]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2" %b, [2 x i16]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2" %c, [2 x i8]* noalias nocapture nonnull "fpga.decayed.dim.hint"="2" %result) local_unnamed_addr #0 {
entry:
  %a_copy = alloca [2 x [2 x i8]], align 512
  %b_copy = alloca [2 x [2 x i8]], align 512
  %c_copy = alloca [2 x [2 x i16]], align 512
  %result_copy = alloca [2 x [2 x i8]], align 512
  ...
  call fastcc void @copy_in([2 x [2 x i8]]* nonnull %0, [2 x [2 x i8]]* nonnull align 512 %a_copy, [2 x [2 x i8]]* nonnull %1, [2 x [2 x i8]]* nonnull align 512 %b_copy, [2 x [2 x i16]]* nonnull %2, [2 x [2 x i16]]* nonnull align 512 %c_copy, [2 x [2 x i8]]* nonnull %3, [2 x [2 x i8]]* nonnull align 512 %result_copy)
  call void @apatb_calculate_matrix_hw([2 x [2 x i8]]* %a_copy, [2 x [2 x i8]]* %b_copy, [2 x [2 x i16]]* %c_copy, [2 x [2 x i8]]* %result_copy)
  call void @copy_back([2 x [2 x i8]]* %0, [2 x [2 x i8]]* %a_copy, [2 x [2 x i8]]* %1, [2 x [2 x i8]]* %b_copy, [2 x [2 x i16]]* %2, [2 x [2 x i16]]* %c_copy, [2 x [2 x i8]]* %3, [2 x [2 x i8]]* %result_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_in([2 x [2 x i8]]* noalias readonly, [2 x [2 x i8]]* noalias align 512, [2 x [2 x i8]]* noalias readonly, [2 x [2 x i8]]* noalias align 512, [2 x [2 x i16]]* noalias readonly, [2 x [2 x i16]]* noalias align 512, [2 x [2 x i8]]* noalias readonly, [2 x [2 x i8]]* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a2a2i8([2 x [2 x i8]]* align 512 %7, [2 x [2 x i8]]* %6)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([2 x [2 x i8]]* noalias, [2 x [2 x i8]]* noalias readonly align 512, [2 x [2 x i8]]* noalias, [2 x [2 x i8]]* noalias readonly align 512, [2 x [2 x i16]]* noalias, [2 x [2 x i16]]* noalias readonly align 512, [2 x [2 x i8]]* noalias, [2 x [2 x i8]]* noalias readonly align 512) unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a2a2i8([2 x [2 x i8]]* %6, [2 x [2 x i8]]* align 512 %7)
  ret void
}

declare void @apatb_calculate_matrix_hw([2 x [2 x i8]]*, [2 x [2 x i8]]*, [2 x [2 x i16]]*, [2 x [2 x i8]]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([2 x [2 x i8]]* noalias, [2 x [2 x i8]]* noalias readonly align 512, [2 x [2 x i8]]* noalias, [2 x [2 x i8]]* noalias readonly align 512, [2 x [2 x i16]]* noalias, [2 x [2 x i16]]* noalias readonly align 512, [2 x [2 x i8]]* noalias, [2 x [2 x i8]]* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a2a2i8([2 x [2 x i8]]* %6, [2 x [2 x i8]]* align 512 %7)
  ret void
}

define void @calculate_matrix_hw_stub_wrapper([2 x [2 x i8]]*, [2 x [2 x i8]]*, [2 x [2 x i16]]*, [2 x [2 x i8]]*) #5 {
entry:
  call void @copy_out([2 x [2 x i8]]* null, [2 x [2 x i8]]* %0, [2 x [2 x i8]]* null, [2 x [2 x i8]]* %1, [2 x [2 x i16]]* null, [2 x [2 x i16]]* %2, [2 x [2 x i8]]* null, [2 x [2 x i8]]* %3)
  %4 = bitcast [2 x [2 x i8]]* %0 to [2 x i8]*
  %5 = bitcast [2 x [2 x i8]]* %1 to [2 x i8]*
  %6 = bitcast [2 x [2 x i16]]* %2 to [2 x i16]*
  %7 = bitcast [2 x [2 x i8]]* %3 to [2 x i8]*
  call void @calculate_matrix_hw_stub([2 x i8]* %4, [2 x i8]* %5, [2 x i16]* %6, [2 x i8]* %7)
  call void @copy_in([2 x [2 x i8]]* null, [2 x [2 x i8]]* %0, [2 x [2 x i8]]* null, [2 x [2 x i8]]* %1, [2 x [2 x i16]]* null, [2 x [2 x i16]]* %2, [2 x [2 x i8]]* null, [2 x [2 x i8]]* %3)
  ret void
}
