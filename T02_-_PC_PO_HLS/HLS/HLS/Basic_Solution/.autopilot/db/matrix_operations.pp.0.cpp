...
__attribute__((sdx_kernel("calculate_matrix", 0))) void calculate_matrix(
      ...
      result_t result[2][2])
{
#line 16 "/home/pllima0909/Documents/Git/INF01175-Digital-Systems/T02_-_PC_PO_HLS/HLS/HLS/Basic_Solution/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=calculate_matrix
# 8 "HLS_src/matrix_operations.cpp"

   matrix_c_t intermediate;

   VITIS_LOOP_11_1: for(int i = 0; i < 2; i++)
   {
      VITIS_LOOP_13_2: for(int j = 0; j < 2; j++)
      {
         intermediate = 0;

         VITIS_LOOP_17_3: for(int k = 0; k < 2; k++)
