...
set C_modelArgList {
	...
	{ c int 16 regular {array 4 { 1 3 } 1 1 }  }
	{ result int 8 regular {array 4 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	...
	c { ap_memory {  { c_address0 mem_address 1 2 }  { c_ce0 mem_ce 1 1 }  { c_q0 in_data 0 16 } } }
	result { ap_memory {  { result_address0 mem_address 1 2 }  { result_ce0 mem_ce 1 1 }  { result_we0 mem_we 1 1 }  { result_d0 mem_din 1 8 } } }
}
