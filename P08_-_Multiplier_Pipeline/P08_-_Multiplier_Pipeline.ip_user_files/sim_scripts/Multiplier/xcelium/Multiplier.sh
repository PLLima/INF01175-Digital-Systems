...
#
# Script generated by Vivado on Thu Jul 11 10:50:43 -03 2024
...
# script info
echo -e "Multiplier.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
compile()
{
  xmvhdl -work xbip_utils_v3_0_12 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/xbip_utils_v3_0_vh_rfs.vhd" \
  2>&1 | tee compile.log; cat .tmp_log > xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_pipe_v3_0_8 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/xbip_pipe_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_bram18k_v3_0_8 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/xbip_bram18k_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work mult_gen_v12_0_20 -V93 $xmvhdl_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/pllima0909/Documents/Git/INF01175-Digital-Systems/P08_-_Multiplier_Pipeline/P08_-_Multiplier_Pipeline.cache/compile_simlib/xcelium"
  fi
