...
set C_modelArgList {
	...
	{ res int 16 regular {array 4 { 0 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8ns_8ns_16ns_16_4_1_U2", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	matrixmul {
		...
		res {Type O LastRead -1 FirstWrite 12}}}
...
set Spec2ImplPortList { 
	...
	res { ap_memory {  { res_address0 mem_address 1 2 }  { res_ce0 mem_ce 1 1 }  { res_we0 mem_we 1 1 }  { res_d0 mem_din 1 16 } } }
}
